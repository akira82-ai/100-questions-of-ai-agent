...
Let AI do association based on your vault; like you are writing a conflict about a character, it flips out a similar bridge you recorded half a year ago, and you have material at once. Someone reviewed saying the most valuable was exactly the casual fragments; letting AI surface these while writing is faster than staring at a blank page. You screen what AI digs out, not every paragraph should be used, but it puts the material buried in your vault on the table, and the stuck point breaks. Some also do not start from a blank page; they first dictate ideas into the vault by phone, then let AI turn the dictation into a publishable structure, with viewpoints as raw material and AI only doing the structuring, and finally they pass it through a de-roboticizing pass, so the output sounds like they said it, not like a machine wrote it.
